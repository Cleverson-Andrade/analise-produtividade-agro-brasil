...
* **[Bases de Dados Brutas] [yield.csv](yield.csv) / [production.csv](production.csv):** Arquivos originais em CSV utilizados no processamento (devido ao grande volume de dados, o GitHub disponibiliza apenas para download/view raw).
